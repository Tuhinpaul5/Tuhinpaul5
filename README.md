...
Specializing in building robust APIs, scalable infrastructure, and cloud-native systems. **Proficient in Python (FastAPI) as well as PHP (Laravel)**, with deep expertise in managing **PostgreSQL, MySQL, and Redis** for high-performance applications. Had fun with integrating AI/ML capabilities to enhance backend solutions and streamline workflows.
